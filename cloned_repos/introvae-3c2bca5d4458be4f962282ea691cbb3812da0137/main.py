...
# train_dataset, train_iterator, train_iterator_init_op, train_next = data.get_cifar10_dataset(True, args.batch_size, args.train_size)
# test_dataset, test_iterator, test_iterator_init_op, test_next = data.get_cifar10_dataset(False, args.batch_size, args.test_size)
# fixed_dataset, fixed_iterator, fixed_iterator_init_op, fixed_next = data.get_cifar10_dataset(True, args.batch_size, args.latent_cloud_size)
